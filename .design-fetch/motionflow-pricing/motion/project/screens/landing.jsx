...
const LandingScreen = ({ onCta }) => {
  ...
  return (
    <div ref={scrollRef} style={{ width: "100%", height: "100%", overflow: "auto", background: "var(--bg-0)", color: "var(--ink-0)", fontFamily: "'Geist', system-ui, sans-serif", position: "relative" }}>
      <TopNav onCta={onCta}/>
    ...
    <section style={{ position: "relative", padding: "32px 56px 96px", overflow: "hidden", isolation: "isolate" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 1320, margin: "0 auto", paddingTop: 80 }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: 28 }}>
          ...
          <div className="mf-mono" style={{ marginTop: -8, fontSize: 11, color: "var(--ink-3)", letterSpacing: "0.10em" }}>
            NO CARD · 3 FREE CREDITS · YOUR FIRST VIDEO IN 60 SECONDS
          </div>
...
/* ─────── SCROLL REEL: scrubs as you scroll ─────── */
const ScrollReel = ({ f, y }) => {
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
        <div>
          ...
          <h2 style={{ margin: 0, fontSize: 64, fontWeight: 500, letterSpacing: "-0.035em", lineHeight: 1.05 }}>
            ...
            <span style={{
              background: "linear-gradient(135deg, #FF6B6B, #FCA5A5)",
        ...
        {/* Right: stack of "bad" video thumbnails getting crossed out */}
    ...
    <section style={{ padding: "120px 0", overflow: "hidden", borderBottom: "1px solid var(--line)" }}>
      ...
      <Marquee speed={40}>
        {items.concat(items).map((it, i) => (
          <span key={i} style={{ fontSize: 56, fontWeight: 500, letterSpacing: "-0.02em", color: i % 3 === 0 ? "var(--ink-0)" : "var(--ink-4)", padding: "0 32px" }}>
            {it}
          </span>
        ))}
      </Marquee>
...
const HowItWorks = ({ f }) => {
  const steps = [
    {
      n: "01", t: "Upload your product",
      d: "Drop screenshots, UI flows, or product URLs.",
      visual: <UploadVisual f={f}/>
    },
    {
      n: "02", t: "Tell the story",
      d: "Add a short script, release notes, or feature bullets.",
      visual: <ScriptVisual/>
    },
    {
    ...
    {
      n: "04", t: "Export everywhere",
      d: "Publish launch-ready content for X, LinkedIn, Product Hunt, App Store, websites, and ads.",
      visual: <ExportVisual/>
    },
  ];
  return (
...
const UploadVisual = ({ f }) => (
  <div style={{ position: "relative", height: "100%", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8 }}>
    {Array.from({ length: 8 }).map((_, i) => {
      ...
      return (
        <div key={i} style={{
          borderRadius: 8, background: `linear-gradient(135deg, oklch(0.5 0.12 ${hue}), oklch(0.25 0.08 ${hue+30}))`,
          border: "1px solid rgba(255,255,255,0.08)",
          transform: `translateY(${lift}px)`, transition: "transform 200ms"
        }}/>
      );
    })}
  </div>
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 14 }}>
          {presets.map((p, i) => (
            ...
            onMouseEnter={(e)=>{e.currentTarget.style.transform="translateY(-4px)"; e.currentTarget.style.borderColor=`${p.accent}66`; e.currentTarget.style.boxShadow=`0 30px 60px -20px ${p.accent}40`;}}
            onMouseLeave={(e)=>{e.currentTarget.style.transform=""; e.currentTarget.style.borderColor="var(--line)"; e.currentTarget.style.boxShadow="";}}>
              <div style={{ aspectRatio: "4/5", background: p.c, position: "relative", overflow: "hidden" }}>
                {/* Animated motion lines that match preset character */}
                <div style={{ position: "absolute", inset: 0 }}>
...
const HyperMotion = ({ f }) => (
  <div style={{ position: "absolute", inset: 0 }}>
    {Array.from({length: 14}).map((_, i) => (
      <div key={i} style={{
        position: "absolute", left: `${(i*7 + f/2) % 100}%`, top: `${10 + (i*13)%80}%`,
    ...
    <section style={{ padding: "140px 56px", borderBottom: "1px solid var(--line)" }}>
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "var(--line)", border: "1px solid var(--line)", borderRadius: 18, overflow: "hidden" }}>
          {cases.map((c, i) => (
            <div key={i} style={{
              padding: "36px 32px", background: "rgba(8,9,13,0.6)", display: "flex", flexDirection: "column", gap: 12, minHeight: 220, position: "relative", cursor: "pointer", transition: "background 200ms"
            }}
    ...
    <section style={{ padding: "120px 0", borderBottom: "1px solid var(--line)", overflow: "hidden", textAlign: "center" }}>
      ...
      <Marquee speed={50}>
        {groups.concat(groups).map((g, i) => (
          <span key={i} style={{ fontSize: 36, fontWeight: 500, letterSpacing: "-0.02em", color: i % 2 === 0 ? "var(--ink-1)" : "var(--ink-3)", padding: "0 28px" }}>
    ...
    <section style={{ padding: "160px 56px", borderBottom: "1px solid var(--line)", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", maxWidth: 1320, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
          {tiers.map((t, i) => (
            <div key={i} style={{
              ...
              borderRadius: 22,
              background: t.featured ? "linear-gradient(180deg, rgba(122,162,255,0.5), rgba(167,139,250,0.2) 60%, rgba(122,162,255,0.05))" : "var(--line)",
              ...
              <div style={{
                ...
                {t.featured && (
                  <div style={{
                    ...
                    background: `radial-gradient(circle at 50% 0%, ${t.accent}25, transparent 60%)`
                  }}/>
                )}
        ...
        <div style={{ marginTop: 96, textAlign: "center", padding: "72px 56px", borderRadius: 24, background: "rgba(8,9,13,0.5)", border: "1px solid var(--line)" }}>
          <h3 style={{ margin: 0, fontSize: 48, fontWeight: 500, letterSpacing: "-0.03em", lineHeight: 1.05, maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ position: "relative", textAlign: "center" }}>
          ...
          <h2 style={{ margin: 0, fontSize: 80, fontWeight: 500, letterSpacing: "-0.04em", lineHeight: 1.0, color: "white" }}>
            ...
            <span style={{
              ...
              WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent"
            }}>Now make it unforgettable.</span>
          </h2>
...
const Marquee = ({ children, speed = 40 }) => (
  <div style={{ overflow: "hidden", whiteSpace: "nowrap", maskImage: "linear-gradient(90deg, transparent, black 10%, black 90%, transparent)" }}>
    <div style={{ display: "inline-flex", animation: `mf-marquee ${speed}s linear infinite` }}>
      {children}
    </div>
    <style>{`@keyframes mf-marquee { from { transform: translateX(0); } to { transform: translateX(-50%); } }`}</style>
  </div>
);
